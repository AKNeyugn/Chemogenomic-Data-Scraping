...
Parse log files generated by OMEGA conformational search and output .txt files containing info of all molecules with warnings.

How to run: python ConformerLogsParser.py

Note: Outputs will have "_Fails" suffix in file name
