test <- read.csv("C:\\Users\\anhkh\\Documents\\UBC\\COOP\\S2019 CARDONA LAB\\Data\\Chemogenomic-Data-Scraping\\Yeast-Data\\CGM\\Spectrum_CGM.csv",sep=",")
mydata <- test[,-1]
...
for (i in 2:12) wss[i] <- sum(kmeans(mydata, 
   centers=i)$withinss)
